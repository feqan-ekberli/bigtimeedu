!(function (a) {
  ...
  function c() {
    a(".circle-progressbar").each(function () {
      var b = a(this).offset().top,
        c = a(window).scrollTop(),
        d = a(this).find(".circle-bar").attr("data-percent"),
        e = (parseInt(d, 10), parseInt(100, 10), a(this).data("animate"));
      b < c + a(window).height() - 30 &&
        !e &&
        (a(this).data("animate", !0),
        a(this)
          .find(".circle-bar")
          .circleProgress({
  ...
  document.addEventListener("DOMContentLoaded", function () {
    window.addEventListener("scroll", function () {
      var b = document.querySelector(".bottom-header").offsetHeight;
    ...
    a(".header-search-form, .search-close").on("click", function (b) {
      b.preventDefault(),
    ...
    a(document).ready(function () {
      loopcounter("time-counter"), a(".example").progressBar({ duration: 1e3 });
    }),
    a(".gallery-slider").slick({
      ...
      prevArrow: !1,
      nextArrow: !1,
      responsive: [{ breakpoint: 479, settings: { slidesToShow: 1 } }],
    }),
    ...
    a("#backTotop").on("click", function (b) {
    ...
    a("#video-container, #video-container-two").modalVideo({
